<h1 color="blue" align="center">HolbertonBnB</h1>
<p  color="red" align="center">An AirBnB clone.</p>
...
The console is a command line interpreter that permits management of HBnB.

### Console Commands

HBnB console supports the following commands:
